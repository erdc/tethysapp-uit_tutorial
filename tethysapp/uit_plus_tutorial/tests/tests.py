...
# from ..app import UitPlusTutorial
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.uit_plus_tutorial"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.uit_plus_tutorial.tests.tests"

        To run tests in the UitPlusTutorialTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.uit_plus_tutorial.tests.tests.UitPlusTutorialTestCase"

        To run only the test_if_tethys_platform_is_great function in the UitPlusTutorialTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.uit_plus_tutorial.tests.tests.UitPlusTutorialTestCase.test_if_tethys_platform_is_great"
...
class UitPlusTutorialTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(UitPlusTutorial)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(UitPlusTutorial)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/uit-plus-tutorial/')  # The final '/' is essential for all pages/controllers
